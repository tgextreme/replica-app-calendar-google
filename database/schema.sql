-- Base de datos para aplicación de calendario web
-- Optimizado para MySQL 9.1.0
-- Soporte para usuarios, grupos, calendarios compartidos y eventos

CREATE DATABASE IF NOT EXISTS web_calendar CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE web_calendar;
...
CREATE TABLE user_groups (
    ...
    description TEXT,
    color VARCHAR(7) DEFAULT '#007bff', -- Color hex para la interfaz
...
CREATE TABLE events (
    ...
    created_by INT NOT NULL,
    updated_by INT,
    recurrence_rule VARCHAR(500), -- Para eventos recurrentes (RRULE format)
    parent_event_id INT, -- Para excepciones de eventos recurrentes
...
CREATE TABLE event_reminders (
    ...
    event_id INT NOT NULL,
    user_id INT NOT NULL,
    remind_before_minutes INT NOT NULL, -- minutos antes del evento
...
INSERT INTO calendars (name, description, color, owner_id, is_default) VALUES
